...
exports.createCourse = async (req, res) => {
    try {
        // extract data
        let { courseName, courseDescription, whatYouWillLearn, price, category, instructions: _instructions, status, tag: _tag, demoVideoUrl, demoVideoType } = req.body;
        ...
        const newCourse = await Course.create({
            ...
            demoVideoType: demoVideoType || 'youtube',
        });
...
exports.getFullCourseDetails = async (req, res) => {
    try {
        ...
        // Check if user is enrolled in this course, is the instructor, or is an admin
        console.log('User accountType:', req.user.accountType);
        console.log('User ID:', userId);
        console.log('Course instructor:', courseDetails.instructor.toString());
        ...
        const isAdmin = req.user.accountType === 'Admin' || req.user.accountType === 'Instructor';
        if (!isEnrolled && !isInstructor && !isAdmin) {
            return res.status(403).json({
                success: false,
                message: 'You are not enrolled in this course. Please purchase the course first.',
            });
        }
