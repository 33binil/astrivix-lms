...
async function run() {
  try {
    ...
    const course = await Course.findOne({ courseName: { $regex: /Web Development/i } });
    if (!course) {
      console.log("Course matching 'Web Development' not found.");
