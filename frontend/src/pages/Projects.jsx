...
import { GiBrain, GiMicrochip, GiCircuitry, GiRobotGolem } from 'react-icons/gi'
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10 w-full">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto mb-10 leading-relaxed">
              Explore real-time projects developed in <span className="text-blue-600 dark:text-blue-400 font-semibold">AI, Robotics, IoT, Embedded Systems</span>, and emerging technologies through practical learning and innovation-driven development.
            </motion.p>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="flex flex-wrap gap-3 items-center justify-between">
            <div className="flex flex-wrap gap-3 items-center">
              <span className="text-slate-600 dark:text-slate-400 font-medium text-sm mr-2">Filter:</span>
            ...
            <span className="text-slate-500 dark:text-slate-400 text-sm">
              <span className="text-blue-600 dark:text-blue-400 font-bold">{filteredProjects.length}</span> projects found
            </span>
          </div>
        </div>
      </section>
                  ...
                  >
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-slate-200 dark:border-white/5">
                        ...
                        <span className="text-blue-600 dark:text-blue-400 text-xs font-semibold flex items-center gap-1 group-hover:gap-2 transition-all">
            ...
            >
              <div className="max-w-md mx-auto">
                <div className="w-20 h-20 bg-slate-100 dark:bg-white/5 border border-slate-300 dark:border-white/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <FiFolder className="w-8 h-8 text-slate-400 dark:text-slate-500" />
                </div>
                <h3 className="text-2xl font-bold text-slate-800 dark:text-white mb-4">No Projects Found</h3>
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/about"
                className="px-8 py-3.5 rounded-full bg-slate-100 dark:bg-white/5 border border-slate-300 dark:border-white/20 text-slate-700 dark:text-white font-bold text-base hover:bg-slate-200 dark:hover:bg-white/10 transition-all duration-300 inline-flex items-center gap-2"
              >
