...
const About = () => {
  return (
    <div className="bg-[#030712] min-h-screen text-white overflow-x-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              ...
              <div className="flex gap-4 sm:gap-6 h-fit w-full max-w-lg mx-auto lg:mx-0">
                <div className="flex flex-col gap-4 w-1/2">
                  <motion.div
                    ...
                    className="w-full aspect-[3/4] bg-white/5 border border-white/10 rounded-[40px_40px_40px_0px] overflow-hidden shadow-lg"
                  >
                  ...
                  <motion.div
                    ...
                    className="w-full aspect-[3/1] bg-gradient-to-br from-blue-500/10 to-indigo-600/10 border border-blue-500/20 rounded-[30px_0px_30px_30px] flex items-center px-4 gap-3"
                  >
                    <img src="/coaching.png" alt="Hands-on guidance" className="w-7 h-7 sm:w-8 sm:h-8 flex-shrink-0 object-contain" />
                    <p className="text-xs sm:text-sm text-slate-300 font-['Afacad']">Hands-on guidance in robotics and embedded systems.</p>
                  </motion.div>
                </div>
                <div className="flex flex-col gap-4 w-1/2 justify-between">
                  <motion.div
                    ...
                    className="w-full aspect-square bg-white/5 border border-white/10 rounded-full overflow-hidden shadow-lg"
                  >
                  ...
                  <motion.div
                    ...
                    className="w-full aspect-[4/3] bg-white/5 border border-white/10 rounded-[0px_40px_40px_40px] overflow-hidden shadow-lg"
                  >
            ...
            >
              <motion.span
                ...
                className="inline-block text-blue-400 font-bold tracking-wider uppercase text-sm mb-4"
              >
              ...
              <motion.p
                ...
                className="text-base sm:text-lg text-slate-400 max-w-xl mx-auto lg:mx-0 leading-relaxed mb-8"
              >
      ...
      {/* ===== 2. ABOUT NRET ===== */}
      <section className="py-24 relative bg-white/[0.02] overflow-hidden">
        <GlowBg />
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Nano Robotics Embed Technologies</h3>
                ...
                <div className="flex flex-wrap gap-2 mt-5">
                  <span className="px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-semibold">AI-Powered</span>
                  <span className="px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-semibold">Skill-Based</span>
                  <span className="px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-semibold">Hands-On</span>
                  <span className="px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 text-xs font-semibold">Industry-Ready</span>
                </div>
              </div>
            </motion.div>
            ...
            {[
              ...
              <motion.div
                ...
                className="group relative bg-white/[0.03] border border-white/[0.08] rounded-xl p-6 hover:bg-white/[0.06] hover:border-white/20 transition-all duration-400 hover:-translate-y-1 overflow-hidden flex flex-col"
              >
                ...
                <div className="mt-3 pt-3 border-t border-white/5">
                  <span className="text-blue-400/60 text-[10px] font-semibold tracking-wider uppercase">Pillar {i + 1}</span>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 max-w-5xl mx-auto">
            {domains.map((d, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5 text-center hover:bg-white/[0.08] hover:border-blue-500/30 transition-all duration-300 hover:-translate-y-1 group"
              >
                <div className="w-14 h-14 rounded-xl flex items-center justify-center mx-auto mb-3 text-blue-400 bg-blue-500/10 group-hover:shadow-[0_0_20px_rgba(59,130,246,0.2)] transition-all duration-300">
                  {d.icon}
                </div>
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              viewport={{ once: true }}
              className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 flex flex-col sm:flex-row items-center sm:items-start gap-6 hover:bg-white/[0.08] transition-all duration-300"
            >
              <div className="w-24 h-24 rounded-2xl overflow-hidden bg-gradient-to-br from-blue-500/20 to-cyan-600/20 border border-white/10 flex-shrink-0">
                <img src="/boy.png" alt="Dr. Baba Fakruddin Ali" className="w-full h-full object-cover" />
              </div>
              <div className="text-center sm:text-left">
                <h3 className="text-xl font-bold text-white mb-1">Dr. Baba Fakruddin Ali</h3>
                <p className="text-blue-400 font-semibold text-sm mb-3">Co-founder, NRET</p>
                <ul className="space-y-1.5">
                  <li className="flex items-start gap-2 text-slate-400 text-sm"><FiCheck className="text-blue-400 mt-0.5 shrink-0" size={14} /> Specialized in Embedded Systems, IoT, AI & ML</li>
                  <li className="flex items-start gap-2 text-slate-400 text-sm"><FiCheck className="text-blue-400 mt-0.5 shrink-0" size={14} /> Author of Introduction to ML</li>
                  <li className="flex items-start gap-2 text-slate-400 text-sm"><FiCheck className="text-blue-400 mt-0.5 shrink-0" size={14} /> Holds 3 patents in technology and innovation</li>
                </ul>
              </div>
            </motion.div>
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 flex flex-col sm:flex-row items-center sm:items-start gap-6 hover:bg-white/[0.08] transition-all duration-300"
            >
              <div className="w-24 h-24 rounded-2xl overflow-hidden bg-gradient-to-br from-indigo-500/20 to-purple-600/20 border border-white/10 flex-shrink-0">
                <img src="/girl.png" alt="Dr. Kareem Unisa" className="w-full h-full object-cover" />
              </div>
              <div className="text-center sm:text-left">
                <h3 className="text-xl font-bold text-white mb-1">Dr. Kareem Unisa (PhD)</h3>
                <p className="text-blue-400 font-semibold text-sm mb-3">Founder, NRET</p>
                <ul className="space-y-1.5">
                  <li className="flex items-start gap-2 text-slate-400 text-sm"><FiCheck className="text-blue-400 mt-0.5 shrink-0" size={14} /> Research Development Program Director</li>
                  <li className="flex items-start gap-2 text-slate-400 text-sm"><FiCheck className="text-blue-400 mt-0.5 shrink-0" size={14} /> PhD researcher at VIT focusing on AI-driven bots</li>
                  <li className="flex items-start gap-2 text-slate-400 text-sm"><FiCheck className="text-blue-400 mt-0.5 shrink-0" size={14} /> Specialized in research and practical AI learning</li>
                </ul>
              </div>
            </motion.div>
          </div>
