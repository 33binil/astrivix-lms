        ...
        <button className="relative sm:hidden" onClick={() => setOpen(true)}>
            ...
            {open && (
                ...
                >
                    ...
                    <div className="flex flex-col w-full text-sm text-richblack-100 border-y border-richblack-700 ">
                        <div className="flex items-center gap-x-1 py-[10px] px-[12px] font-semibold bg-richblack-700/50">
                            <PiNotebook className="text-lg" />
                            Catalog
                        </div>
                        <div className="flex flex-col pl-4 max-h-[200px] overflow-y-auto bg-richblack-900/40">
                            {loading ? (
                                <p className="py-2 text-xs">Loading...</p>
                                ...
                                subLinks.map((subLink, i) => (
                                    <Link
                                        ...
                                        className="py-2 px-2 hover:text-[#2A86F7] transition-colors"
                                    >
                                        {subLink.name}
                                    </Link>
                                ))
                            ) : (
                                <p className="py-2 text-xs">No categories</p>
                            )}
                        </div>
                    </div>
